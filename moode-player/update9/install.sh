...
INPLACE_UPDATE_DATE="2025-10-07"
SQLDB=/var/local/www/db/moode-sqlite3.db

# Part 2: List of package updates (cumulative)
PKG_UPDATES=(
moode-player=9.4.1-1moode1
...
log2ram=1.7.2
librespot=0.7.1-1moode1
peppy-alsa=2024.02.10-1moode1
peppy-meter=2025.6.3-1moode1
peppy-spectrum=2024.5.26-1moode1
pleezer=0.19.1-1moode1
...
KERNEL_NEW_VER="6.12.47"
KERNEL_NEW_PKGVER="1:6.12.47-1+rpt1~bookworm"
